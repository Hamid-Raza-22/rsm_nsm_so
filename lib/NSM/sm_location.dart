...
class _SMLocationnsmState extends State<SMLocationnsm> {
  ...
  final Map<String, LatLng> _dummyMarkers = {
    '📍 SM 1 (Islamabad)': const LatLng(33.6844, 73.0479),  // Islamabad
    '📍 SM 2 (Lahore)': const LatLng(31.5497, 74.3436),     // Lahore
    '📍 SM 3 (Sialkot)': const LatLng(32.5149, 74.5430),     // Sialkot
    '📍 SM 4 (Peshawar)': const LatLng(34.0151, 71.5249),    // Peshawar
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("SM Live Location"),
