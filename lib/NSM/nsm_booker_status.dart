...
class NSM_BookerStatus extends StatefulWidget {
  @override
  _NSM_BookerStatusState createState() => _NSM_BookerStatusState();
}

class _NSM_BookerStatusState extends State<NSM_BookerStatus> {
