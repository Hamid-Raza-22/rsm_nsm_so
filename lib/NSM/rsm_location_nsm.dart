...
class RSM_Location_nsm extends StatefulWidget {
  @override
  _RSM_Location_nsmState createState() => _RSM_Location_nsmState();
}

class _RSM_Location_nsmState extends State<RSM_Location_nsm> {
  late GoogleMapController mapController;

  final Map<String, LatLng> _dummyMarkers = {
    '📍 RSM 1 (Islamabad)': const LatLng(33.6844, 73.0479),  // Islamabad
    '📍 RSM 2 (Lahore)': const LatLng(31.5497, 74.3436),     // Lahore
    '📍 RSM 3 (Sialkot)': const LatLng(32.5149, 74.5430),     // Sialkot
    '📍 RSM 4 (Peshawar)': const LatLng(34.0151, 71.5249),    // Peshawar
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("RSM's Live Location"),
