...
class SMShopVisitPage extends StatelessWidget {
  final TextEditingController rsmNameController = TextEditingController(text: 'ABC');
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildAnimatedTextField('RSM Name', rsmNameController, Icons.person),
